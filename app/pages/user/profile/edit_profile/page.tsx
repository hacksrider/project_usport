...
//             });
//             setPreviewImage(`/${userData.user_profile_picture}` || null);
//           }
//         } catch (error) {
...
//         ...formData,
//         [name]: file,
//         // isProfileChange: (name == "user_profile_picture"),
//         // isContractChange: (name == "accom_rent_contrac_photo"),
//         // isCardChange: (name == "ID_card_photo")
//       });
...
//         router.push("/pages/user/profile"); // Redirect after successful update
//       }
//     } catch (error) {
