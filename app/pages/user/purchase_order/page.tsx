                ...
                {loading ? (
                    ...
                    <div>
                        <div className="bg-white shadow-md rounded-lg p-5">
                            <div className="flex justify-between items-center mb-5">
                                <h1 className="text-2xl font-semibold text-black">บริการออกกำลังกาย</h1>
                            ...
                            {buyingService.length === 0 ? (
                                ...
                                <table className="w-full border-collapse border border-gray-300">
                                    ...
                                    <tbody>
                                        {buyingService.map((order, i) => {console.log(order);return(
                        ...
                        <div className="bg-white shadow-md rounded-lg p-5 mt-3">
                            <div className="flex justify-between items-center mb-5">
                                <h1 className="text-2xl font-semibold text-gray-800">คำสั่งจองสนาม</h1>
                                <button className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded" onClick={() => router.push("/pages/user/football/")}>+ จองสนาม</button>
                            </div>
                                                ...
                                                <table className="min-w-full table-auto border-collapse">
                                                    <thead className="bg-gray-200 ">
                                                        <tr className='text-center'>
                                                            <th className="px-4 py-2 border-b  text-sm text-gray-600">No.</th>
                                ...
                                <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center z-50">
                                    <div className="bg-white p-6 rounded-lg max-w-[800px] w-full max-h-[100vh] overflow-y-auto" >
                                        ...
                                        <div className="flex justify-center items-center mt-4">
                                            <img src={previewImgBanking ? 'http://localhost:4000/' + previewImgBanking : undefined} alt="Uploaded Payment" className="mt-4 max-w-full h-auto" />
                                        </div>
                                        <input
                                            className="mb-[15px]"
                                            type="file"
