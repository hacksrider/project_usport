...
export default function ProfileAdmin() {
  ...
  const [adminData, setAdminData] = useState<any>(); // แก้ไขตามโครงสร้างข้อมูล API ของคุณ
  ...
  return (
    <MainLayoutAdmin>
      ...
      <div className="w-[800px] bg-gray-300 p-2 rounded shadow-md mx-auto mb-5 mt-6">

        <div className="mx-auto w-full max-w-[850px] my-2">
          <div className="overflow-hidden rounded-[10px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card">
            <div className="relative z-20 h-[200px] md:h-65">
              <img
            ...
            <div className="px-4 pb-4 text-center">
              ...
              <div className="mt-4">
                {/* <h3 className="mb-1 text-heading-6 font-bold text-dark dark:text-white">
                  {adminData.emp_username + " " + adminData.emp_lastname || "N/A"}
                </h3> */}
                {/* <p className="font-medium">{adminData.data.emp_job || "N/A"}</p> */}
                {/* {adminData.emp_job ? <p className="text-sm text-gray-400">ผู้จัดการ</p> : <p className="text-sm text-gray-400">พนักงาน</p>}  */}
                    ...
                    <table className="table-auto w-full text-left border-collapse border border-gray-300">
                      <tbody>
                        <tr>
                          ...
                          <td className="px-4 py-2 border border-gray-300">{adminData.emp_name || "N/A"}</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 border border-gray-300 font-semibold text-gray-800">นามสกุล</td>
                          <td className="px-4 py-2 border border-gray-300"> {adminData.emp_lastname || "N/A"}</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 border border-gray-300 font-semibold text-gray-800">ชื่อผู้ใช้</td>
                          <td className="px-4 py-2 border border-gray-300">{adminData.emp_username || "N/A"}</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 border border-gray-300 font-semibold text-gray-800">อีเมล</td>
                          <td className="px-4 py-2 border border-gray-300">{adminData.emp_email || "N/A"}</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 border border-gray-300 font-semibold text-gray-800">เพศ</td>
                          <td className="px-4 py-2 border border-gray-300">{adminData.emp_sex || "N/A"}</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 border border-gray-300 font-semibold text-gray-800">มือถือ</td>
                          <td className="px-4 py-2 border border-gray-300">{adminData.emp_tel || "ไม่ระบุ"}</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 border border-gray-300 font-semibold text-gray-800">ตำแหน่ง</td>
                          <td className="px-4 py-2 border border-gray-300">{adminData.emp_job ? "ผู้จัดการ" : "พนักงาน"}</td>
                        </tr>
                      </tbody>
                    </table>
