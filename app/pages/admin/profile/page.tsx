...
export default function ProfileAdmin() {
  ...
  return (
    <MainLayoutAdmin>
      <h1 className="text-2xl font-semibold mb-3 text-black">โปรไฟล์</h1>
        ...
        <div className="overflow-hidden rounded-[10px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card">
          <div className="relative z-20 h-35 md:h-65">
            <Image
              ...
              height={260}
              style={{
                width: "100%", // จำกัดให้ภาพยืดเต็มพื้นที่พ่อแม่
                height: "auto", // รักษาสัดส่วนเดิมของภาพ
                maxWidth: "1500px", // จำกัดความกว้างสูงสุด
                maxHeight: "260px", // จำกัดความสูงสูงสุด
              }}
            />
              ...
              <div className="mx-auto max-w-[720px]">
                <div className="col-span-2 p-6">
                  ...
                  <div className="flex justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-4xl">
                      <div className="flex flex-col">
                        ...
                        <div className="text-lg font-semibold text-gray-800">เกียรติภูมิ</div>
                      </div>
                      <div className="flex flex-col">
                        <label className="text-sm text-gray-500">นามสกุล</label>
                        <div className="text-lg font-semibold text-gray-800">โภคา</div>
                      </div>
                      <div className="flex flex-col">
                        <label className="text-sm text-gray-500">อีเมล</label>
                        <div className="text-lg font-semibold text-gray-800">hacks@me.com</div>
                      </div>
                      <div className="flex flex-col">
                        <label className="text-sm text-gray-500">ชื่อผู้ใช้</label>
                        <div className="text-lg font-semibold text-gray-800">hacks123</div>
                      </div>
                      <div className="flex flex-col">
                        <label className="text-sm text-gray-500">วัน/เดือน/ปี เกิด</label>
                        <div className="text-lg font-semibold text-gray-800">12/05/1998</div>
                      </div>
                      <div className="flex flex-col">
                        <label className="text-sm text-gray-500">อายุ</label>
                        <div className="text-lg font-semibold text-gray-800">25 ปี</div>
                      </div>
                      <div className="flex flex-col">
                        <label className="text-sm text-gray-500">มือถือ</label>
                        <div className="text-lg font-semibold text-gray-800">098-1256325</div>
                      </div>
                      <div className="flex flex-col">
                        <label className="text-sm text-gray-500">เพศ</label>
                        <div className="text-lg font-semibold text-gray-800">ชาย</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-8 text-right">
                    <button
                      onClick={() => router.push("/pages/user/edit_profile")}
