    ...
    const sendDataToAPI = async () => {
        try {
            ...
            if (response.status === 200) {
                alert('เปลี่ยนแปลงราคาเรียบร้อยแล้ว')
            } else {
                                        ...
                                        >
                                            <div className='flex flex-row justify-center flex-wrap bg-gray-300 p-6 rounded-[20px]'>
                                                ...
                                                <div className='flex flex-row item-center justify-center'>
                                                    <div
                                                        className={`rounded-full w-[25px] h-[25px] border-[1px] border-black mr-3 ${e.status ? 'bg-green-500' : 'bg-red-500'
                                                            }`}
                                                    ></div>
                                                    {e.status ? 'เปิด' : 'ปิด'}
                                                </div>
                            ...
                            <div className="mb-4 flex items-center">
                                <label className="flex items-center cursor-pointer">
                                    ...
                                    <div className="relative">
                                        ...
                                        <div
                                            className={`w-14 h-8 rounded-full shadow-inner transition-colors ${isChecked ? "bg-green-500" : "bg-gray-300"
                                                }`}
                                        ></div>

                                        <div
                                            className={`absolute top-1 left-1 w-6 h-6 bg-white rounded-full shadow-md transform transition-transform ${isChecked ? "translate-x-6" : "translate-x-0"
                                                }`}
                                        ></div>
                                    </div>
