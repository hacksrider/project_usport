...
//                                             onClick={() => {
//                                                 setActiveMenu('exercise_order');
//                                                 router.push('/pages/admin/exercise_order');
//                                             }}
//                                         >
//                                             <span className="mr-3">
...
//                                             </span>
//                                             คําสั่งซื้อ
//                                             <span className="ml-auto bg-gray-300 text-red-900 rounded-full px-2 text-[10px]">5</span>
//                                         </li>
//                                         <li
...
//                                         <li
//                                             className={`cursor-pointer flex items-center px-2 py-1 rounded ${activeMenu === 'employee' ? 'bg-gray-500' : ''}`}
//                                             onClick={() => {
