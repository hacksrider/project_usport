...
var checkAndUpdateBookings = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 6, , 7]);
                return [4 /*yield*/, db_1.default.bookings.findMany({
                        where: {
                            order: {
            ...
            case 1:
                ...
                _a.label = 2;
            case 2:
                if (!(_i < bookings_1.length)) return [3 /*break*/, 5];
            ...
            case 3:
                _a.sent();
                console.log("\u0E2D\u0E31\u0E1B\u0E40\u0E14\u0E15 booking ID ".concat(booking.booking_ID, " \u0E40\u0E1B\u0E47\u0E19 '\u0E40\u0E01\u0E34\u0E19\u0E01\u0E33\u0E2B\u0E19\u0E14\u0E08\u0E48\u0E32\u0E22'"));
                _a.label = 4;
            case 4:
                _i++;
                return [3 /*break*/, 2];
            ...
            case 6:
                error_1 = _a.sent();
                console.error('เกิดข้อผิดพลาดในการอัปเดตสถานะการจอง:', error_1);
                return [3 /*break*/, 7];
