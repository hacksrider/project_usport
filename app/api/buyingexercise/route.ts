...
//       });
//       // @ts-expect-error
//       res.time_and_price.sort((a, b) => b.quantity_of_days - a.quantity_of_days);
...
//       expire_date: new Date(new Date(entry.expire_date).getTime() + (new Date().getTimezoneOffset() * 60000)),
